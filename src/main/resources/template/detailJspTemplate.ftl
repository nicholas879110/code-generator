            ...
            <form action="/${lowerName}/update" class="form-horizontal form-border" method="post" id="update-${lowerName}-form">
                ...
                <div class="form-group no-margin-left no-margin-right">
                    ...
                    <div class=" col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input class="form-control" type="text" name="${item.fieldName}" disabled>
                        </div>
                    </div>
                </div>
                #end
...
<script type="text/javascript" src="${ctx}/assets/js/${moduleName}/${lowerName}/detail.js"/>
